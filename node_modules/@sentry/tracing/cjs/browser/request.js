...
function shouldAttachHeaders(
  ...
  if (tracePropagationTargets || tracingOrigins) {
    return utils.stringMatchesSomePattern(url, tracePropagationTargets || tracingOrigins);
  }
  return utils.stringMatchesSomePattern(url, DEFAULT_TRACE_PROPAGATION_TARGETS);
}
